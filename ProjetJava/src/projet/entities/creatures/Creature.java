...
public abstract class Creature extends Entity {
	...
	public static final int DEFAULT_CREATURE_WIDTH = 32//screen.getScreenWidthVoulu()*5/100,
							,DEFAULT_CREATURE_HEIGHT = 32;//screen.getScreenHeightVoulu()*5/100;
	...
	public void moveY(){
		if(yMove < 0){//Up
			...
			if(!collisionWithTile((int) (x + bounds.x) / Tile.TILEWIDTH, ty) &&
				...
				y = ty * Tile.TILEWIDTH - bounds.y -bounds.height -1;
			}
		}
	}
